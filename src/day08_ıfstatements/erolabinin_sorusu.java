...
public class erolabinin_sorusu {
...
2.  Sistem bize "Kaç kişilik bilet istiyorsunuz? (Max 2 kişilik olabilir):   "   sorusunu sorsun.
    ...
    public static void main(String[] args) {
        ...
        System.out.println("  ZAFER TURİZM' E HOŞGELDİNİZ");
        ...
        if (gidilecekSehir=="FRANKFURT"){
            System.out.println("Rota = Frankfurt");
            int frankfurtbiletfiyatıhesabı=(frakfurtkm/kmbirimFiyat)*5;
            System.out.println("Frankfurt "+ frankfurtbiletfiyatıhesabı+ "Euro");
