...
public class Fp05 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("herhangiBirKursAdiKelimeyiİceriyorMu ="+herhangiBirKursAdiKelimeyiİceriyorMu(coursesList,"x"));
       ortalamaPuanıEnYuksekOlanKursunAdiniYazdir(coursesList);
        System.out.println();
    ...
    public static boolean herhangiBirKursAdiKelimeyiİceriyorMu(List<Courses>list, String kelime){
    ...
    public static void ortalamaPuanıEnYuksekOlanKursunAdiniYazdir (List<Courses>list){
