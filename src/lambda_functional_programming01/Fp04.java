...
public class Fp04 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("VerilenikiSayiArasindaToplamiBul  " + VerilenikiSayiArasindaToplamiBul(11,5));
        System.out.println("VerilenİkiSayıArasındakiTümSayılarınRakamlarınınToplami  " + VerilenİkiSayıArasındakiTümSayılarınRakamlarınınToplami(13,11));
    ...
    public static int get7den100eToplam01() {
        ...
        return IntStream.
                range(7, 101).// range collection a ceviriyor
    ...
    public static int get7den100eToplam02() {
        ...
        return IntStream.
                rangeClosed(7, 100).// range collection a ceviriyor
                        reduce(Math::addExact).getAsInt();
    }
    ...
    public static int faktoriyelHesapla(int x) {
        ...
        System.out.println(" odan buyuk deger giriniz");
        return 0;
    }

    //4) Verilen iki sayı arasındaki çift sayıların toplamını bulan bir method oluşturun.

    public static int VerilenikiSayiArasindaToplamiBul (int x, int y){
        int z=0;
...
if (x>y){
    ...
    public static int VerilenİkiSayıArasındakiTümSayılarınRakamlarınınToplami (int x, int y){
        int z=0;
