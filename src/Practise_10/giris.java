...
import Practise_10.Okul_Proje.OgretmenBilgileri;
...
public class giris {
 /*
    ...
    public static void main(String[] args) {
        ...
        List<OgretmenBilgileri> ogretmenList = new ArrayList<>();//burayı yazmasak da olur bize göstermek için yazmıs

        ogretmenList.add(adayOgretmen);// aynı ust satırda ki gibi burası yazılmasa da oluyor
