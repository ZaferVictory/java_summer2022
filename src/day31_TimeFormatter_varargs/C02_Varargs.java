...
public class C02_Varargs {
    ...
    public static void toplaYazdir(int sayi1, int sayi2, int sayi3) {// 2 parametreli bir methoda 3.sayiyi ekleyemediği için
        System.out.println("Verilen uc sayinin toplami : " + (sayi1+sayi2+sayi3));// 3 parametreli yeni bir array olusturduk.
    }
