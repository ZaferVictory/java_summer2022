...
public class M03_Iterator {
    ...
    public static void main(String[] args) {
        ...
        for (Integer each:liste) {
            each+=3;
            System.out.print(each+" ");//13 23 33  bu atamma burada for eac loop ıcınde kaldı. dısarıda gene sout yaptıgımda
                                        // gene oncekını yazdırıyor.
        }
        System.out.println();
       ...
       /* Java index yapisi olmaya collection'lardaki
        ...
        //System.out.println(it1.next());// 30 dan sonra element kalmadıgından RTE verir
