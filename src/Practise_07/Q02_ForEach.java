...
public class Q02_ForEach {
    ...
    /*
     ...
     print length of each elemen
     Part 2:
     Print all the elements from array using for eachLoop
     If an element starts with 'v' then quit the loop

     String[] list = {"meyveler", "sebzeler", "et", "süt"}; her döngü için dizi yazdır
      her öğenin uzunluğunu yazdır
      Bölüm 2: for eachLoop kullanarak dizideki tüm öğeleri yazdırın
       Bir öğe 'v' ile başlıyorsa döngüden çıkın
     */
