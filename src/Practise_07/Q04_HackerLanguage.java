...
//    İpucu harfleri değiştirin ve ekrana yazdırın.
    ...
    public static void main(String[] args) {
        ...
        hackerdili(str);// bu benim yaptıgim metod
        ...
        hackerdiliHocaninKi(cumle);

    }

    private static void hackerdiliHocaninKi(String cumle) {
    ...
    private static void hackerdili(String str) {
        ...
        str=str.replace("s","5").replace("a","4").replace("e","3")
                .replace("i","1").replace("o","0");

        System.out.println(str);//j4v4 1l3 h3r53y guz3l
