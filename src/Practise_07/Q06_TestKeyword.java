...
*/
    ...
    private static void testsonucu(char[][] answers, char[] keys) {
        ...
        for (int i = 0; i < answers.length; i++) {// her bir ögrenciye bakar i==> ögrenciyi temsil ediyor

            int sayac=0;// herbir ögrencinin dogru cevabını sayacagi icin sayac buraya konur
            for (int j = 0; j < answers[i].length ; j++) { // j==> ögrenci cevapları kontrolediyor
